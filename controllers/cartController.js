...
const WSresponse = require("../libs/WSresponse.js");
...
const createCart = async (req, res) => {
  try {
    const response = await cartService.createCart(req.body.user, req.body.products);
    console.log(req.body)

    // Mensaje wp a cliente
    ...
    const usuario = await User.findOne({ _id: req.body.user });
